...
SceneCmd hall2_scene_header00[] = {
    ...
    SCENE_CMD_COL_HEADER(&hall2_collisionHeader),
...
RomFile hall2_scene_roomList[] = {
    { (u32)_hall2_room_0SegmentRomStart, (u32)_hall2_room_0SegmentRomEnd },
};
...
Vec3s hall2_camPosData[3] = {
	{ 0, 0, 0 },
	{ 5659, 58199, 167 },
	{ 3960, -1, -1 },
};

BgCamInfo hall2_camData[1] = {
	{ CAM_SET_NONE, 3, &hall2_camPosData[0] },
};

SurfaceType hall2_polygonTypes[] = {
	{ 0x00000000, 0x00000000 },
};

CollisionPoly hall2_polygons[] = {
...
CollisionHeader hall2_collisionHeader = {
	-968,
	-120,
	-300,
	300,
