...
RoomShapeNormal testmap001_room_1_shapeHeader = {
    ...
    ARRAY_COUNT(testmap001_room_1_shapeDListEntry),
    testmap001_room_1_shapeDListEntry,
    testmap001_room_1_shapeDListEntry + ARRAY_COUNT(testmap001_room_1_shapeDListEntry)
};

RoomShapeDListsEntry testmap001_room_1_shapeDListEntry[1] = {
    { testmap001_room_1_entry_0_opaque, NULL },
};

Gfx testmap001_room_1_entry_0_opaque[] = {
	gsSPDisplayList(testmap001_dl_Floor_001_mesh_layer_Opaque),
	gsSPEndDisplayList(),
};

Vtx testmap001_dl_Floor_001_mesh_layer_Opaque_vtx_cull[8] = {
...
Vtx testmap001_dl_Floor_001_mesh_layer_Opaque_vtx_0[4] = {
...
Gfx testmap001_dl_Floor_001_mesh_layer_Opaque_tri_0[] = {
	gsSPVertex(testmap001_dl_Floor_001_mesh_layer_Opaque_vtx_0 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSPEndDisplayList(),
};

Gfx testmap001_dl_Floor_001_mesh_layer_Opaque[] = {
	gsSPClearGeometryMode(G_LIGHTING),
	gsSPVertex(testmap001_dl_Floor_001_mesh_layer_Opaque_vtx_cull + 0, 8, 0),
	gsSPSetGeometryMode(G_LIGHTING),
	gsSPCullDisplayList(0, 7),
	gsSPDisplayList(mat_testmap001_dl_floor_mat_layerOpaque),
	gsSPDisplayList(testmap001_dl_Floor_001_mesh_layer_Opaque_tri_0),
	gsSPEndDisplayList(),
};
