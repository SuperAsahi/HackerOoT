...
#define LENGTH_TESTMAP001_ROOM_0_HEADER00_ACTORLIST 6
...
RoomShapeNormal testmap001_room_0_shapeHeader = {
    ...
    ARRAY_COUNT(testmap001_room_0_shapeDListsEntry),
    testmap001_room_0_shapeDListsEntry,
    testmap001_room_0_shapeDListsEntry + ARRAY_COUNT(testmap001_room_0_shapeDListsEntry)
};

RoomShapeDListsEntry testmap001_room_0_shapeDListsEntry[1] = {
    { testmap001_room_0_shapeHeader_entry_0_opaque, NULL }
};

Gfx testmap001_room_0_shapeHeader_entry_0_opaque[] = {
	gsSPDisplayList(testmap001_room_0_dl_Cube_mesh_layer_Opaque),
	gsSPDisplayList(testmap001_room_0_dl_Floor_mesh_layer_Opaque),
	gsSPEndDisplayList(),
};

Vtx testmap001_room_0_dl_Cube_mesh_layer_Opaque_vtx_cull[8] = {
...
Vtx testmap001_room_0_dl_Cube_mesh_layer_Opaque_vtx_0[24] = {
...
Gfx testmap001_room_0_dl_Cube_mesh_layer_Opaque_tri_0_cel0[] = {
...
Gfx testmap001_room_0_dl_Cube_mesh_layer_Opaque_tri_0[] = {
	gsSPVertex(testmap001_room_0_dl_Cube_mesh_layer_Opaque_vtx_0 + 0, 24, 0),
	gsDPPipeSync(),
	...
	gsSPDisplayList(testmap001_room_0_dl_Cube_mesh_layer_Opaque_tri_0_cel0),
	gsSPAlphaCompareCull(G_ALPHA_COMPARE_CULL_DISABLE, 0),
	gsSPEndDisplayList(),
};

Vtx testmap001_room_0_dl_Floor_mesh_layer_Opaque_vtx_cull[8] = {
...
Vtx testmap001_room_0_dl_Floor_mesh_layer_Opaque_vtx_0[4] = {
...
Gfx testmap001_room_0_dl_Floor_mesh_layer_Opaque_tri_0[] = {
	gsSPVertex(testmap001_room_0_dl_Floor_mesh_layer_Opaque_vtx_0 + 0, 4, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSPEndDisplayList(),
};

Gfx mat_testmap001_room_0_dl_f3dlite_material_layerOpaque[] = {
...
Gfx testmap001_room_0_dl_Cube_mesh_layer_Opaque[] = {
	gsSPClearGeometryMode(G_LIGHTING),
	gsSPVertex(testmap001_room_0_dl_Cube_mesh_layer_Opaque_vtx_cull + 0, 8, 0),
	gsSPSetGeometryMode(G_LIGHTING),
	gsSPCullDisplayList(0, 7),
	gsSPDisplayList(mat_testmap001_room_0_dl_f3dlite_material_layerOpaque),
	gsSPDisplayList(testmap001_room_0_dl_Cube_mesh_layer_Opaque_tri_0),
	gsSPEndDisplayList(),
};

Gfx testmap001_room_0_dl_Floor_mesh_layer_Opaque[] = {
	gsSPClearGeometryMode(G_LIGHTING),
	gsSPVertex(testmap001_room_0_dl_Floor_mesh_layer_Opaque_vtx_cull + 0, 8, 0),
	gsSPSetGeometryMode(G_LIGHTING),
	gsSPCullDisplayList(0, 7),
	gsSPDisplayList(mat_testmap001_room_0_dl_floor_mat_layerOpaque),
	gsSPDisplayList(testmap001_room_0_dl_Floor_mesh_layer_Opaque_tri_0),
	gsSPEndDisplayList(),
};
